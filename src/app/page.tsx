          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-8">
              ...
              <h1 className="text-5xl md:text-6xl font-black leading-tight tracking-tight text-slate-900 dark:text-white">
                ...
                <br />
                Save the{" "}
                <span className="text-blue-600 font-extrabold">Tow.</span>
              </h1>

              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-125 leading-relaxed">
                Register your vehicle and stay reachable during parking issues —
                without ever sharing your phone number. Communicate safely using
                secure QR codes.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href={"/search"}>
                  <Button
                    variant={"outline"}
                    className="font-bold h-14 px-10 rounded-xl shadow-lg shadow-primary/20 transition-all flex items-center justify-center"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col gap-1 p-6 rounded-xl bg-white dark:bg-slate-800/50 shadow-sm border border-[#cfdde7] dark:border-slate-700">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="bg-indigo-100 dark:bg-indigo-300 text-indigo-600 px-2 py-0.5 rounded text-xs font-bold">
                  24/7 Reachable
                </span>
              </div>
            </div>
            <div className="flex flex-col gap-1 p-6 rounded-xl bg-white dark:bg-slate-800/50 shadow-sm border border-[#cfdde7] dark:border-slate-700">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="bg-[#078838]/10 text-[#078838] px-2 py-0.5 rounded text-xs font-bold">
                  Anonymous
                </span>
              </div>
            </div>
        ...
        <section className="py-24">
          <div className="flex flex-col gap-4 mb-16 max-w-180">
            <h2 className="text-4xl font-black tracking-tight">
              Modern Vehicle Safety, Built for Privacy
            </h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
              Stay connected while keeping your personal data private. Our
              platform ensures you&apos;re always reachable for emergencies
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col gap-4 p-8 rounded-2xl border border-[#cfdde7] dark:border-slate-800 bg-white dark:bg-slate-800 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                  Communicate anonymously without sharing your phone number. Get
                  notified instantly via Email when something happens to your
                  car.
                </p>
              </div>
            </div>
            <div className="flex flex-col gap-4 p-8 rounded-2xl border border-[#cfdde7] dark:border-slate-800 bg-white dark:bg-slate-800 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                  Get notified immediately Email if something happens to your
                  car, from parking issues to emergencies.
                </p>
              </div>
            </div>
            <div className="flex flex-col gap-4 p-8 rounded-2xl border border-[#cfdde7] dark:border-slate-800 bg-white dark:bg-slate-800 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                  Generate your unique QR code in seconds, print it and stick it
                  on your car.
                </p>
              </div>
            </div>
        ...
        <section className="py-24 bg-white dark:bg-slate-800/30 rounded-3xl border border-[#cfdde7] dark:border-slate-800 px-8 md:px-16 overflow-hidden relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                Setting up your secure profile takes less than 2 minutes. No
                technical skills required.
              </p>
              <div className="grid grid-cols-[48px_1fr] gap-x-4 mt-4">
                <div className="flex flex-col items-center">
                  <div className="size-12 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold">
                    1
                  </div>
                ...
                <div className="flex flex-col py-2">
                  ...
                  <p className="text-slate-500 text-sm">
                    Add your plate number and fill required details.
                  </p>
                </div>
                <div className="flex flex-col items-center">
                  <div className="size-12 rounded-full border-2 border-primary text-primary flex items-center justify-center font-bold">
                    2
                  </div>
                  <div className="w-0.5 bg-[#cfdde7] dark:bg-slate-700 h-16 my-2"></div>
                </div>
                ...
                <div className="flex flex-col py-2">
                  ...
                  <p className="text-slate-500 text-sm">
                    Anyone can scan the code to send you a message through our
                    portal.
                  </p>
                </div>
              </div>
        ...
        <section className="py-24 text-center">
          <div className="max-w-200 mx-auto flex flex-col items-center gap-8">
            ...
            <p className="text-sm text-slate-400">
              No credit card required for basic registration.
            </p>
          </div>
        </section>
      </main>
